...
namespace SalesWebMVC.Data
{
    ...
    {
        private SalesWebMVCContext _context; // Registra dependencia com DBContext (SalesWebMVCContext)

        public SeedingService(SalesWebMVCContext context)
        {
            _context = context; // Fazendo a injecao de dependencia
        }

        public void Seed()
        {
            // Testa se ja tem algo na base de dados
            ...
            // Mandar adicionar esses objs no BD
